...
public class TestGPGMenu : MonoBehaviour ,IPointerClickHandler
{
    ...
    //leaderboard strings
    private string leaderboard = "CgkIp9i27cUfEAIQBg";
    //achievement strings
    private string achievement = "CgkIp9i27cUfEAIQAQ";
    private string incremental = "CgkIp9i27cUfEAIQAg";
